document.addEventListener('DOMContentLoaded', () => {
    ...
    const songs = [
        ...
        { title: 'Baby Powder - Jenevieve', file: '../music/Baby Powder - Jenevieve.mp3' },
        { title: '夕阳之歌 - 梅艳芳', file: '../music/夕阳之歌 - 梅艳芳.mp3' },
        { title: '黄昏 - 周传雄', file: '../music/黄昏 - 周传雄.mp3' },
        { title: '离别 - 阿杜', file: '../music/离别 - 阿杜.mp3' },
        { title: '信仰 - 张信哲', file: '../music/信仰 - 张信哲.mp3' },
