...
function closeFirstPrompt() {
  ...
  setTimeout(showSecondPrompt, 3000); // 5秒后显示第二个提示框
}
...
function closeSecondPrompt() {
  ...
  setTimeout(showThirdPrompt, 3000); // 5秒后显示第三个提示框
}
...
function closeThirdPrompt() {
  ...
  setTimeout(showFourthPrompt, 3000); // 5秒后显示第四个提示框
}
...
function closeFourthPrompt() {
  ...
  setTimeout(showFifthPrompt, 3000); // 5秒后显示第五个提示框
}
...
function closeFifthPrompt() {
  ...
  setTimeout(showSixthPrompt, 3000); // 5秒后显示第六个提示框
}
...
// 跳转到首页并显示最终提示框
function leave() {
  var currentPrompt = document.querySelector(".prompt:not([style='display: none;'])");
  if (currentPrompt && currentPrompt.id === "sixthPrompt") {
